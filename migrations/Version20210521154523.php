 ...
 */
final class Version20210521154523 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE media ADD user_id INT NOT NULL, ADD trick_id INT NOT NULL');
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_6A2CA10CA76ED395 ON media (user_id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_6A2CA10CA76ED395 ON media');
        $this->addSql('DROP INDEX IDX_6A2CA10CB281BE2E ON media');
        $this->addSql('ALTER TABLE media DROP user_id, DROP trick_id');
    }
}
