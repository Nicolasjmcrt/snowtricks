 ...
 */
final class Version20210605095906 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE media (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, trick_id INT NOT NULL, caption VARCHAR(255) NOT NULL, file_name VARCHAR(255) NOT NULL, display_order INT NOT NULL, UNIQUE INDEX UNIQ_6A2CA10CA76ED395 (user_id), INDEX IDX_6A2CA10CB281BE2E (trick_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
